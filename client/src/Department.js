...
function Department() {
    ...
    const deleteData =async (stfid) => {
        const res7 = await fetch(`/deletedepartment/${stfid}/${id}`, {
            method: "GET",
            headers: {
              "Content-Type": "application/json"
            },
            ...
            <div class="sales-boxe">
                <div class="recent-sales box">
                    <div style={{ display: "flex", justifyContent: "space-between" }}>
                        ...
                        <div><NavLink to={`/departmentadd/${id}`} > <a><button className='btn btn-primary'>Add Panchayat <i class='bx bx-plus'></i></button> </a></NavLink> </div>
                    </div>
                    <hr />
                        ...
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Department Website</th>
