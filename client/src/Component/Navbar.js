                ...
                <div class="container d-flex align-items-center ml-4 p-0">
                    ...
                    <nav id="navbar" class="navbar">
                        <ul>
                            ...
                            <li class="dropdown"><a href="#"><span>Services</span> <i
                                ...
                                <ul>
                                    <NavLink to={`/taludapanchayat/${id}`} style={{ margin: 0, padding: 0 }}>
                                        ...
                                        <li><a href="#">Taluka Panchayat Form</a></li>
                                    </NavLink>
                                    <NavLink to={`/grampanchayat/${id}`} style={{ margin: 0, padding: 0 }}>

                                        <li><a href="#">Gram Panchayat Form</a></li>
                                    </NavLink>
                                </ul>
                            </li>
                            ...
                            <li><a class="nav-link scrollto" href="#">Feedback & Contact</a></li>
</NavLink>
