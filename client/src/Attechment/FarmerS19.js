    ...
    <div class="page-breadcrumb position-static">
        <div class="container">
            <ul class="breadcrumb justify-content-center fw-bold pt-2" style={{backgroundColor:"#0c3c53"}}>
                ...
                <li class="text-white" style={{paddingLeft:5}}>S19 - Farmer Certificate</li>
            </ul>
        </div>
    </div>
</div>
...
<div class="container">
        <div class="row">
            <div class="col-lg-10 mx-auto mt-5 col-md-6 border">
                ...
                <div>
                    <h6 style={{color:"#209dd8"}}>
                        <i class="bi bi-check-all"></i>	Certified copy of village reg. no. 7/12, no. 8-A & No. 6 for which land is assumed to. <br />
                        ...
                        <i class="bi bi-check-all"></i>	Self-Declaration. <br />
                    </h6>
                </div>
