    ...
    <div class="page-breadcrumb position-static">
        <div class="container">
            <ul class="breadcrumb justify-content-center fw-bold pt-2" style={{backgroundColor:"#0c3c53"}}>
                ...
                <li class="text-white" style={{paddingLeft:5}}>S110 - Addition of Name in Ration Card</li>
            </ul>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-lg-10 mx-auto mt-5 col-md-6 border">
                <div class="section-title pt-5">
                    <h2>S110 - Addition of Name in Ration Card</h2>
                </div>
                ...
                <div>
                    <h3 class="pb-4 pt-5" style={{color:"#0C3C53"}}><i class="bi bi-chevron-double-right"></i> Mandatory Document : </h3>
                </div>

                <div>
                    <h6 style={{color:"#209dd8"}}>
                        <i class="bi bi-check-all"></i>	Original Ration Card. <br />
                    </h6>
                </div>

                <div>
                    <h3 class="pb-4 pt-5" style={{color:"#0C3C53"}}><i class="bi bi-chevron-double-right"></i> Proof Needed In Service Attachment : </h3>
                </div>

                <div>
                    <h6 style={{color:"#209dd8"}}>
                        <i class="bi bi-check-all"></i>	Copy of probate obtained on bases of Will. <br />
                        <i class="bi bi-check-all"></i>	True copy of Registered Sale. <br />
                        <i class="bi bi-check-all"></i>	Marriage Certificate. <br />
                        <i class="bi bi-check-all"></i>	True Copy of Election Card. <br />
                    </h6>
                </div>
